  ...
  (setq-default
   ...
   '(
     ...
     (shell :variables
            ...
            shell-default-eshell 'multi-term)
     ;; spell-checking
     ;; syntax-checking
     ;; version-control
     )
